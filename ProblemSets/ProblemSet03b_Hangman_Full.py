...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    lettersGuessed = [] #list of letters guessed
    mistakesMade = 0 #mistakes made, tally up to 8 and end when it gets there
    while isWordGuessed(secretWord, lettersGuessed) == False:
        currentLetter = raw_input("Please guess a letter: ")
        currentLetter = currentLetter.lower() # make lower case
        currentLetter = currentLetter[0:1] # make sure we just read the first word
